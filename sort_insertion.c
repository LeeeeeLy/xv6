...
void sortn_insertion(char *arr[], int n);/*sort by number(uses atoi)*/
void sorts_insertion(char *arr[], int n, int e);/*sort by string(uses comp)*/
...
//insertion sort
void 
sortn_insertion(char *arr[], int n){
  int i, j;
  char *tmp;

  sorts_insertion(arr,n,0);

  for (i = 1; i < n; i++){
    tmp = arr[i];
    j = i - 1;
    while (j >= 0 && ft_atoi(arr[j]) > ft_atoi(tmp)){
      arr[j+1] = arr[j];
      j--;
    }
    arr[j+1] = tmp;
...
sortu(char *arr[], int n){
  ...
  sorts_insertion(arr,n-c,0);
  return c;
}

void 
list(char *arr[], int n, int e){
  int i, j;
...
sortM(char *arr[], int n){
 ...
 // printf(1,"sum is %d\n", j1+j2+j3+j4+j5+j6+j7+j8+j9+j10+j11+j12);
  ...
  sorts_insertion(arr,n-c,0);
  list(arr,n-c+j1,n-c);
  list(arr,n-c+j1+j2,n-c+j1);
  list(arr,n-c+j1+j2+j3,n-c+j1+j2);
  list(arr,n-c+j1+j2+j3+j4,n-c+j1+j2+j3);
  list(arr,n-c+j1+j2+j3+j4+j5,n-c+j1+j2+j3+j4);
  list(arr,n-c+j1+j2+j3+j4+j5+j6,n-c+j1+j2+j3+j4+j5);
  list(arr,n-c+j1+j2+j3+j4+j5+j6+j7,n-c+j1+j2+j3+j4+j5+j6);
  list(arr,n-c+j1+j2+j3+j4+j5+j6+j7+j8,n-c+j1+j2+j3+j4+j5+j6+j7);
  list(arr,n-c+j1+j2+j3+j4+j5+j6+j7+j8+j9,n-c+j1+j2+j3+j4+j5+j6+j7+j8);
  list(arr,n-c+j1+j2+j3+j4+j5+j6+j7+j8+j9+j10,n-c+j1+j2+j3+j4+j5+j6+j7+j8+j9);
  list(arr,n-c+j1+j2+j3+j4+j5+j6+j7+j8+j9+j10+j11,n-c+j1+j2+j3+j4+j5+j6+j7+j8+j9+j10);
  list(arr,n-c+j1+j2+j3+j4+j5+j6+j7+j8+j9+j10+j11+j12,n-c+j1+j2+j3+j4+j5+j6+j7+j8+j9+j10+j11);
...
//insertion sort
void 
sorts_insertion(char *arr[], int n, int e){
  int i, j;
  char temp2[512];
  ...
  for (i = e+1; i < n; i++) {
    strcpy(temp2, arr[i]);
    j = i - 1;
    while (comp(arr[j],temp2)>0 && j >= 0) {
      //arr[j + 1] = arr[j];
      strcpy(arr[j+1], arr[j]);
      j = j-1;
    }
    strcpy(arr[j+1], temp2);
    //arr[j+1] = temp2;
  }
}
