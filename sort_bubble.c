...
void sortn_bubble(char *arr[], int n);/*sort by number(uses atoi)*/

void sorts_bubble(char *arr[], int n, int e);/*sort by string(uses comp)*/
...
void 
sortn_bubble(char *arr[], int n){
  int i, j;

  sorts_bubble(arr,n,0);

  for (i = 0; i < n - 1; i++){
    for (j = 0; j < n-i-1; j++){
      if(ft_atoi(arr[j]) > ft_atoi(arr[j+1])){
        strcpy(temp, arr[j]);
...
sortM(char *arr[], int n){
 ...
 // printf(1,"sum is %d\n", j1+j2+j3+j4+j5+j6+j7+j8+j9+j10+j11+j12);
  ...
  sorts_bubble(arr,n-c,0);
  sorts_bubble(arr,n-c+j1,n-c);
  sorts_bubble(arr,n-c+j1+j2,n-c+j1);
  sorts_bubble(arr,n-c+j1+j2+j3,n-c+j1+j2);
  sorts_bubble(arr,n-c+j1+j2+j3+j4,n-c+j1+j2+j3);
  sorts_bubble(arr,n-c+j1+j2+j3+j4+j5,n-c+j1+j2+j3+j4);
  sorts_bubble(arr,n-c+j1+j2+j3+j4+j5+j6,n-c+j1+j2+j3+j4+j5);
  sorts_bubble(arr,n-c+j1+j2+j3+j4+j5+j6+j7,n-c+j1+j2+j3+j4+j5+j6);
  sorts_bubble(arr,n-c+j1+j2+j3+j4+j5+j6+j7+j8,n-c+j1+j2+j3+j4+j5+j6+j7);
  sorts_bubble(arr,n-c+j1+j2+j3+j4+j5+j6+j7+j8+j9,n-c+j1+j2+j3+j4+j5+j6+j7+j8);
  sorts_bubble(arr,n-c+j1+j2+j3+j4+j5+j6+j7+j8+j9+j10,n-c+j1+j2+j3+j4+j5+j6+j7+j8+j9);
  sorts_bubble(arr,n-c+j1+j2+j3+j4+j5+j6+j7+j8+j9+j10+j11,n-c+j1+j2+j3+j4+j5+j6+j7+j8+j9+j10);
  sorts_bubble(arr,n-c+j1+j2+j3+j4+j5+j6+j7+j8+j9+j10+j11+j12,n-c+j1+j2+j3+j4+j5+j6+j7+j8+j9+j10+j11);
...
//bubble sort
void 
sorts_bubble(char *arr[], int n, int e){
  int i, j;
